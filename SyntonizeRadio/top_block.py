...
# Title: Top Block
# Generated: Tue Oct 19 11:56:10 2021
##################################################
...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.gain = gain = 1
        self.freq = freq = 98.7e6

        ##################################################
        # Blocks
        ##################################################
        self._gain_range = Range(0.1, 100, 1, 1, 200)
        self._gain_win = RangeWidget(self._gain_range, self.set_gain, "gain", "counter_slider", float)
        self.top_grid_layout.addWidget(self._gain_win)
        self._freq_range = Range(80e6, 120e6, 1000, 98.7e6, 200)
        self._freq_win = RangeWidget(self._freq_range, self.set_freq, 'Frecuencia central', "counter_slider", float)
        ...
        self.low_pass_filter_0 = filter.fir_filter_ccf(1, firdes.low_pass(
        	gain, 48000, 20e3, 500, firdes.WIN_HAMMING, 6.76))
    ...
    def set_gain(self, gain):
        self.gain = gain
        self.low_pass_filter_0.set_taps(firdes.low_pass(self.gain, 48000, 20e3, 500, firdes.WIN_HAMMING, 6.76))
